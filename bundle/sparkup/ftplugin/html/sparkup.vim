...
if !exists('g:sparkupExecuteNMapping')
  let g:sparkupExecuteNMapping = '<leader>ee'
endif
if !exists('g:sparkupExecuteIMapping')
  let g:sparkupExecuteIMapping = '<c-e>'
endif

if !exists('g:sparkupNextNMapping')
  let g:sparkupNextNMapping = '<leader>en'
endif
if !exists('g:sparkupNextIMapping')
  let g:sparkupNextIMapping = '<c-n>'
endif

exec 'nnoremap <buffer> ' . g:sparkupExecuteNMapping . ' :call <SID>Sparkup()<cr>'
exec 'inoremap <buffer> ' . g:sparkupExecuteIMapping . ' <c-g>u<Esc>:call <SID>Sparkup()<cr>'
exec 'nnoremap <buffer> ' . g:sparkupNextNMapping . ' :call <SID>SparkupNext()<cr>'
"exec 'inoremap <buffer> ' . g:sparkupNextIMapping . ' <c-g>u<Esc>:call <SID>SparkupNext()<cr>'
